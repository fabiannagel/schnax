...
class DistanceExpansionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.schnet_expansions, self.schnax_expansions = activation.get_distance_expansion(schnet_activations,
                                                                                           schnax_activations)
    ...
    def test_distance_expansions(self):
        ...
        np.testing.assert_allclose(self.schnet_expansions, relevant_schnax_expansions, rtol=self.rtol, atol=self.atol)
